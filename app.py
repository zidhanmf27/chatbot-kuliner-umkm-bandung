...
<div class="footer-text">
    ...
    <p style="margin-top:0.5rem; opacity:0.8;"><i class="fas fa-code"></i> Developed by <a href="https://zidhanmf-portofolio.vercel.app/" target="_blank" style="font-weight: 600;">zidhanmf</a></p>
</div>
""", unsafe_allow_html=True)